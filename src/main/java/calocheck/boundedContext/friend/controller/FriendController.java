package calocheck.boundedContext.friend.controller;
...
public class FriendController {
    ...
    public String follow(@PathVariable Long followingId) {
        ...
        return rq.redirectWithMsg("/member/mypage/%s".formatted(followingId), followRsData);
    }
    ...
    public String unfollow(@PathVariable Long followingId) {
        ...
        return rq.redirectWithMsg("/member/mypage/%s".formatted(followingId), unfollowRsData);
    }
